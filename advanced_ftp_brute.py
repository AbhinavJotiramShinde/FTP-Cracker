...
def main():
    ...
    parser.add_argument('--chars', type=str, help='Characters to use for password generation.', default=string.ascii_letters + string.digits)
    ...
    if not args.user and not args.userlist:
        print("Please provide a single username or userlist file.")
        sys.exit(1)
